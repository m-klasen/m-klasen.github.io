...
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-popup-title",va:"Du bist nicht angemeldet"},{G:"div",L:"ytp-mdx-popup-description",va:"Videos, die du dir ansiehst, werden m\u00f6glicherweise zum TV-Wiedergabeverlauf hinzugef\u00fcgt und k\u00f6nnen sich damit auf deine TV-Empfehlungen auswirken. Melde dich auf einem Computer in YouTube an, um das zu vermeiden."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Ia:["ytp-button",
"ytp-mdx-privacy-popup-cancel"],va:"Abbrechen"},{G:"button",Ia:["ytp-button","ytp-mdx-privacy-popup-confirm"],va:"Best\u00e4tigen"}]}]}]});this.i=new g.QK(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.I(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},N9=function(a){g.W.call(this,{G:"div",
...
b=g.T(b,128)?g.rH("Fehler auf $RECEIVER_NAME",c):b.Ic()||g.T(b,4)?g.rH("Wiedergabe \u00fcber $RECEIVER_NAME",c):g.rH("Verbunden mit $RECEIVER_NAME",c);a.Qa("statustext",b);a.i.show()}else a.i.hide()},O9=function(a,b){g.xP.call(this,"Wiedergeben auf",0,a,b);
...
O9.prototype.uj=function(a){return"cast-selector-receiver"===a?"Streamen\u2026":this.Ko[a].name};
